...
if [ "$DFX_NETWORK" = "local" ]; then
  ...
  echo "VITE_ISSUER_DERIVATION_ORIGIN=${ISSUER_ORIGIN}" >> $ENV_FILE
  echo "VITE_RP_CANISTER_ID=${RP_CANISTER_ID}" >> $ENV_FILE
  echo "VITE_RP_ORIGIN=${RP_ORIGIN}" >> $ENV_FILE
  echo "VITE_RP_DERIVATION_ORIGIN=${RP_ORIGIN}" >> $ENV_FILE
...
if [ "$DFX_NETWORK" = "mainnet" ]; then
  ...
  ISSUER_DERIVATION_ORIGIN="https://${META_ISSUER_CANISTER_ID}.icp0.io"
  ...
  echo "VITE_ISSUER_CANISTER_ID=${META_ISSUER_CANISTER_ID}" >> $ENV_FILE
  echo "VITE_ISSUER_ORIGIN=${ISSUER_ORIGIN}" >> $ENV_FILE
  echo "VITE_ISSUER_DERIVATION_ORIGIN=${ISSUER_DERIVATION_ORIGIN}" >> $ENV_FILE
  echo "VITE_RP_CANISTER_ID=${RP_CANISTER_ID}" >> $ENV_FILE
  echo "VITE_RP_ORIGIN=${RP_ORIGIN}" >> $ENV_FILE
  echo "VITE_RP_DERIVATION_ORIGIN=${RP_DERIVATION_ORIGIN}" >> $ENV_FILE
  echo "VITE_HOST=${HOST}" >> $ENV_FILE
  echo "VITE_FETCH_ROOT_KEY=false" >> $ENV_FILE
fi
